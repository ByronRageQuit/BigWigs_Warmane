...
L:RegisterTranslations("enUS", function() return {
	...
	doomfire = "Doomfire Strike",
	doomfire_desc = "Warn for doomfire strike",
} end )
...
mod.guid = 17968
mod.toggleoptions = {"grip", "icon", "fear", "burst", "doomfire", "burstsay", "proximity", "bosskill"}
...
--      Event Handlers      --
------------------------------
function mod:Doomfire(_, spellID)
	self:Bar("Doomfire", 20, "Spell_fire_selfdestruct")
end
